========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet decodetiff
========================================================================

AppWizard a créé cette application decodetiff pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application decodetiff.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé decodetiff.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
